...
from emirecords.config.models import MediarecordsConfig
from emirecords.services.mediarecords import errors as e
from emirecords.services.mediarecords import models as m
from emirecords.utils import asyncify, syncify
from emirecords.utils.read import ReadableIterator
from emirecords.utils.time import httpparse
...
class MediarecordsService:
    """Service for mediarecords database."""

    def __init__(self, config: MediarecordsConfig) -> None:
        self._client = Minio(
