...
from gecko.api.routes.ping import errors as e
from gecko.api.routes.ping import models as m
from gecko.services.ping import errors as pe
from gecko.services.ping import models as pm
