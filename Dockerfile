...
ENV EMIRECORDER__HOST=0.0.0.0 \
    EMIRECORDER__PORT=31000 \
    EMIRECORDER__TARGET_HOST=localhost \
    EMIRECORDER__TARGET_PORT=30000 \
    EMIRECORDER__TARGET_USER=readwrite \
    EMIRECORDER__TARGET_PASSWORD=password
